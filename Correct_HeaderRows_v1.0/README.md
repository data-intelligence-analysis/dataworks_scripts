...
A standard script to remove special characters from the data fields of a client's raw data and identify duplicate data fields within the header row of the client's raw data.
